...
import com.sad.androidroomtodolist.R;
...
public class MainActivity extends AppCompatActivity implements RecyclerViewAdapter.ClickListener, AdapterView.OnItemSelectedListener {
    ...
    private void buildDummyTodos() {
        Todo todo = new Todo();
        todo.name = "vajnichko";
        todo.description = "neshto vajno";
        todo.category = "Important";

        todoArrayList.add(todo);

        todo = new Todo();
        todo.name = "ne mnogo vajnichko";
        todo.description = "ne tolkova vajno";
        todo.category = "less important";

        todoArrayList.add(todo);

        todo = new Todo();
        todo.name = "kinda";
        todo.description = "kinda";
        todo.category = "kinda important";

        todoArrayList.add(todo);

        todo = new Todo();
        todo.name = "meh";
        todo.description = "just meh";
        todo.category = "meh";
